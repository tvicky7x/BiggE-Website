            ...
            {!burger && (
              <div className=" relative sm:hidden">
                ...
                {props.cartData.length > 0 && (
                  <span className="p-1.5 rounded-full bg-red-500 absolute -right-1"></span>
                )}
              </div>
            )}
            ...
            <li>
              ...
              >
                <div className="inline relative">
                  ...
                  {props.cartData.length > 0 && (
                    <span className="p-1.5 rounded-full bg-red-500 absolute -right-1 -top-0.5"></span>
                  )}
                </div>
              </button>
            </li>
                ...
                >
                  <div className="relative inline">
                    ...
                    <svg
                      ...
                      strokeWidth="1.5"
                      stroke="currentColor"
                      className="w-6 h-6 inline -mt-1.5"
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    {props.cartData.length > 0 && (
                      <span className="p-1.5 rounded-full bg-red-500 absolute -right-1.5"></span>
                    )}
                  </div>
                </button>
              </li>
